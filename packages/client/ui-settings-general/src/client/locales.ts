...
export const zh = {
  ...
  'desktop.section.nav': '桌面',
  'desktop.section.check': '检查更新',
  'desktop.section.upToDate': '已是最新版本',
...
export const en = {
  ...
  'desktop.section.nav': 'Desktop',
  'desktop.section.check': 'Check for updates',
  'desktop.section.upToDate': 'Up to date',
